...
class EmployeeGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("employeeapp:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Employee entity")
        ...
        .formParam("client_id", "employeeapp")
        ...
        .repeat(2) {
            ...
            .repeat(5) {
                ...
                .get("/employee${new_employee_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created employee")
            .delete("/employee${new_employee_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
