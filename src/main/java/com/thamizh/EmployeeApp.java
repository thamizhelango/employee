...
import com.thamizh.client.OAuth2InterceptedFeignConfiguration;
import com.thamizh.config.ApplicationProperties;
import com.thamizh.config.DefaultProfileUtil;
...
public class EmployeeApp {
    ...
    public EmployeeApp(Environment env) {
        this.env = env;
    }
